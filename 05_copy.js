...
// 참조 자료형인 녀석들은 복사할 떄 신경 써줘야 함
// 실제로 Heap 메모리 영역에 저장되는 값은 실제값이 아니라 "주소값"이기 때문.
...
var sCopyUser = originalUser;       // originalUser의 값을 복사해서 sCopyUser에게 복수하는데, 이 "값"은 "주소값"
                                         // 얕은 복사 (swallow copy)
...
//     name: oUser2.name,
//     age: oUser2.age,
//     address: oUser2.address,       // 객체 안에 key를 갖고 있는 프로퍼티가 있다면, 덮어쓰기됨
//     address: {
//         ...oUser2.address,
//     }
// };